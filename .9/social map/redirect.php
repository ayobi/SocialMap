...
$count = 10; // enter count of recent images.
...
echo '<img src="'.$image['images']['standard_resolution']['url'].'" height="100" width="100">'; // display recent images.
//echo (" <br></br> ");
//echo 'Lat: '.$image['location']['latitude'];
//echo ' Lng: '.$image['location']['longitude'];
//echo (" <br></br> ");
}
$count = 1;
echo (" <br> ");
...
echo 'Picture ' .$count;
echo ' - Lat: '.$image['location']['latitude'];
echo ' Long: '.$image['location']['longitude'];
$count = $count + 1;
echo (" <br> ");
}
...
$access_token = $_SESSION['access_token'];
	...
	{	
		...
		$qry="DELETE FROM images WHERE user = '$username' ORDER BY id DESC LIMIT 1";
	...
	function displayimage()
	{
		...
		{
			echo '<img height="225" width="225" src="data:image;base64,'.$row[image].' "> ';
		}
		mysql_close($con); 
	}
?>
		...
		<form method="post" enctype="multipart/form-data">
			<div class='CONT_Default'>
				<h2 class='H_Partial'>File Upload: Drag Image and drop into url text box</h2>
